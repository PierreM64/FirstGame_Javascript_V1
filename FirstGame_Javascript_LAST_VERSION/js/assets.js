...
const assetsToLoadURLs = {
    ...
    */
    ...
    musicDawnNewWord: {
      url:
        "./assets/audio/SerengetiSong.mp3",
      buffer: true,
      loop: true,
      volume: 0.7,
    },
    ...
    musicRestart: {
      url:
        "./assets/audio/EtherealEternity.mp3",
      buffer: true,
      loop: true,
      volume: 0.7,
    },
